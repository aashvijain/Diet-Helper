...
prompt = ChatPromptTemplate.from_messages(
    [
        ("system", "You are a helpful assistant that can analyze images of nutrition charts amd help choose the right diet"),
        (
            "human",
            [
...
uploaded_file2 = st.file_uploader("Upload the second", type=["jpg", "jpeg", "png"])
